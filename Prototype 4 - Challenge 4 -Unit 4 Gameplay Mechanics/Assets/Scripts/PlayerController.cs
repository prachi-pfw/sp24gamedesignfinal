...
public class PlayerController : MonoBehaviour
{
    ...
    public float hitForce = 100f; // Adjust the hit force as needed
    ...
    private void OnTriggerEnter(Collider other){
        ...
        if (other.CompareTag("Enemy"))
        {
            ...
            // Normalize the direction vector to maintain consistent force magnitude
            direction.Normalize();
            ...
            if (enemyRigidbody != null)
            {
                ...
                enemyRigidbody.AddForce(-direction * hitForce, ForceMode.Impulse);
            }
        }
    }
